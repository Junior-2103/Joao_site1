...
if botao == True:
    ...
    st.image(r'https://github.com/Junior-2103/Joao_site1/blob/main/IMG_20220720_200754.jpg')
...
if botao1 == True:
    ...
    st.image(r'https://github.com/Junior-2103/Joao_site1/blob/main/IMG_20240225_184102.jpg')
